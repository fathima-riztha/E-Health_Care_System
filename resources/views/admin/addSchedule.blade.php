                ...
                @endif
                 ...
                 <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form action="{{url('upload_doctorschedule')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div >
                                        ...
                                        <br>
                                       <select name="docid" style="height: 40px; width: 200px; border: none; " >
                                            <option>Select</option>
                                             @foreach($doctor as $doctors)
                                            <option value="{{ $doctors->id }}">{{$doctors->id }}</option>
                                            @endforeach
                                ...
                                <div class="col-md-6">
                                    <div >
                                        ...
                                        <br>
                                        <select name="name" style="height: 40px; width: 200px; border: none; " >
                                            <option>Select</option>
                                             @foreach($doctor as $doctors)
                                            <option>{{$doctors->id .'-'. $doctors->firstname . ' ' . $doctors->lastname }}</option>
                                            @endforeach
