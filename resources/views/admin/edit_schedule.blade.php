                ...
                @endif
                 ...
                 <div class="row">
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <form action="{{url('updateSchedule',$data->id)}}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="col-md-6">
                                    <div >
                                        ...
                                        <label>Doctor Id</label>
                                         <input class="form-control" type="text" name="docid" required="" value="{{$data->doctor_id}}" style="color: black;">
                                ...
                                <div class="col-md-6">
                                    <div >
                                        ...
                                        <label>Doctor Name</label>
                                         <input class="form-control" type="text" name="name" required="" value="{{$data->doc_name}}" style="color: black;">
                                        <br>
                        ...
                        <div class="col-md-6">
                          ...
                          <input type="text" name="days" class="form-control" value="{{$data->days}}">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div >
                                            <input type="text" class="form-control"  name="time1" value="{{$data->start_time}}">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div >
                                            <input type="text" class="form-control"  name="time2" value="{{$data->end_time}}">
                                        </div>
                                    </div>
                                </div>
                           ...
                           <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn">Edit Schedule</button>
                            </div>
