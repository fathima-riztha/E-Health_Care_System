        ...
        <div id="sidebar-menu" class="sidebar-menu">
         ...
         <div class="page-wrapper">
            <div class="content">
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                       <form action="{{ url('editAccount', $user->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Email </label>
                                        <input class="form-control" style="background-color: white;" type="text" name="email" value="{{$user->email}}" >
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Password</label>
                                        <input class="form-control" style="background-color: white;" type="password" name="pwd" value="{{$user->password}}" >
                                    </div>
                                </div>
