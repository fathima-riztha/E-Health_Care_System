                    ...
                    <div class="col-lg-8 offset-lg-2">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Name </label>
                                        <input class="form-control" style="background-color: white;" type="text" name="name" value="{{$user->name}}" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Patient Id</label>
                                        <input class="form-control" style="background-color: white;" type="text" name="id" value="{{ $user->id }}" readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Address </label>
                                        <input class="form-control" style="background-color: white;" type="text" name="address" value="{{$user->address}}"    readonly>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Phone Number </label>
                                        <input class="form-control" style="background-color: white;" type="text" name="pno" value="{{$user->phone}}" readonly>
                                    </div>
                                </div>   
                            </div>
                            <div class="row">
                      ...
                      <div class="row">
                        <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Email </label>
                                        <input class="form-control" style="background-color: white;" type="email" name="email" value="{{ $user->email }}" readonly>
                                    </div>
                        </div>
                        <div class="col-sm-6">
                                  <div class="form-group">
                                    ...
                                    <div class="col-12 text-center">
                                          <a href="{{url('user.updateAccount',$user->id)}}" class="btn btn-primary submit-btn">Update account</a>
                                </div> 
                        </div>
