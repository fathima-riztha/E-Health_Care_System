            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <h4 class="page-title"><i class="fa fa-briefcase"></i> Channel Note</h4>
                    </div>
                </div>
                                  ...
                                  @foreach($appointments as $appointment)
                                    <tr>
                                       ...
                                       <td class="text-right">
                                               ...
                                               <a href="{{ url('user.printChannelNote',$appointment->appointment_id) }}" class="action-icon"><i class="fa fa-print"></i></a>  
                                               Print  
                                           </td>
