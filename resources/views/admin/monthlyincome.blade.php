            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{url('admin.printMonthlyIncome')}}" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Print PDF</a>
                                ...
                                <tbody>
                                  ...
                                  @foreach($appointmentsByDoctor as $appointment)
                                    <tr>
                                        ...
                                        <td style="border: 1px solid black;">{{$currentMonth}}-{{$currentYear}}</td>
...
<br>
          ...
          <div class="row">
                ...
                <br><br>
           <form action="{{'upload_monthlyincome'}}" method="POST" enctype="multipart/form-data">
                             @csrf
                             <input  type="hidden" name="total_appointments" value="{{ $appointmentsByDoctor->sum(function ($appointment) {
                                    return  $appointment->total_appointments;
                                                 }) }}">
                             <input  type="hidden" name="monthly_income" value="{{ $appointmentsByDoctor->sum(function ($appointment) {
                                    return $appointment->doctor->appointment_fee * $appointment->total_appointments;
                                    }) - $appointmentsByDoctor->sum(function ($appointment) {
                                         return $appointment->total_appointments * ($appointment->doctor->appointment_fee * 0.6);
                                         }) }}.00">
                                        <input type="hidden" name="month_name" value="{{ $currentMonth }}">

                        <button class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i>Save</button>
            </form>
            <br>
