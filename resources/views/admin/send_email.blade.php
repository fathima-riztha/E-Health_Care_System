            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <h4 class="page-title">Send Email to {{$appointment->email}}</h4>
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        <form action="{{url('send_user_email',$appointment->id)}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="hidden" name="greeting" value="Reminder: " >
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" name="content" class="form-control" value="Your Appointment is scheduled on {{$appointment->appointment_date}} at {{$appointment->appointment_time}}">   
                                    </div>
                                </div>
                             ...
                             <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="hidden" name="conclusion" value="Thank you">
                                    </div>
                                </div>
