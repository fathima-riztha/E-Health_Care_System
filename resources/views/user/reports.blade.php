            ...
            <div class="content">
                <div class="row">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <h4 class="page-title"><i class="fa fa-file"></i> My Reports</h4>
                    </div>
                </div>
                            ...
                            <table class="table table-border table-striped custom-table mb-0">
                                ...
                                <tbody>
                                  ...
                                  @foreach ($testReports as $testReport)
                                    <tr>
                                        <td>{{ $testReport->id }}</td>
                                        <td>{{ $testReport->doctor_name }}</td>
                                        <td>{{ $testReport->test_type }}</td>
                                        <td>{{ $testReport->issue_date }}</td>
                                       <td class="text-right">View
                                               <a href="{{url('/view',$testReport->id)}}" class="action-icon"><i class="fa fa-eye"></i></a>Print 
                                               <a href="{{url('/download',$testReport->file_path)}}" class="action-icon"><i class="fa fa-print"></i></a>  
