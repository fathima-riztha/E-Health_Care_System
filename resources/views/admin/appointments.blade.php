                ...
                <div class="row">
                    <div class="col-sm-4 col-3">
                     ...
                     <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="#" class="btn btn-primary btn-rounded" data-toggle="modal" data-target="#add_event"><i class="fa fa-plus"></i> Add Appointments</a>
                    </div>
                 </div>
                                ...
                                <tbody>
                                  ...
                                  @foreach($appointments as $appointment)
                                    <tr>
                                        ...
                                        <td><img width="28" height="28" src="Admin/assets/img/user.jpg" class="rounded-circle m-r-5" alt="">{{$appointment->patient_name}}</td>
            ...
            <div class="modal-dialog">
                <div class="modal-content modal-md">
                    ...
                    <div class="modal-body">
                        <form action="{{ route('admin.saveAppointmentAndPayment') }}" method="POST">
                            @csrf
                            <div class="form-group">
                                <label>Patient Id <span class="text-danger">*</span></label>
                                <input class="form-control" type="number" name="patient_id" required>
                            </div>
                            <div class="form-group">
                        ...
                        <select class="form-control" name="doc_name">
                            ...
                            <option>{{$doctors->id .'-'. $doctors->firstname . ' ' . $doctors->lastname }}
                            </option>
                            @endforeach
                        ...
                        <select class="form-control" name="doc_id">
                           ...
                           <div class="form-group">
                            ...
                            <div class="m-t-20 text-center">
                                <button type="submit" class="btn btn-primary submit-btn">Add Appointment</button>
                            </div>
                        </form>
                    </div>
                </div>
