            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-8 col-9 text-right m-b-20">
                        <a href="{{url('admin.addDoctors') }}" class="btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Doctor</a>
                    </div>
                </div>
                    ...
                    <div class="col-md-4 col-sm-4  col-lg-3">
                        <div class="profile-widget">
                            <div class="doctor-img">
                                <a class="avatar" href=""><img alt="" src="doctorimage/{{$doctors->image}}"></a>
                            </div>
                            <div class="dropdown profile-action">
                                <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-v"></i></a>
                                <div class="dropdown-menu dropdown-menu-right">
                                    <a class="dropdown-item" href="{{url('edit_doctors',$doctors->id)}}"><i class="fa fa-pencil m-r-5"></i> Edit</a>
                                    <a onclick="return confirm('Are you sure to delete this')" class="dropdown-item"   href="{{url('deletedoctor',$doctors->id)}}" ><i class="fa fa-trash-o m-r-5"></i> Delete</a>
                                </div>
                            </div>
                            <h5 class="doctor-name text-ellipsis"><a href="profile.html">{{$doctors->firstname}}</a></h5>
                             <h5 class="doctor-name text-ellipsis"><a href="profile.html">{{$doctors->lastname}}</a></h5>
                            <div class="doc-prof">{{$doctors->speciality}}</div>
                            <div class="user-country">
                                <i class="fa fa-map-marker"></i> {{$doctors->address}}
                            </div>
                        </div>
                    </div>
